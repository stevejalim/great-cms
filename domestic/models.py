...
from core.models import CMSGenericPage, Tag, Country, IndustryTag
...
class CountryGuidePage(panels.CountryGuidePagePanels, Page):
...
class ArticlePage(panels.ArticlePagePanels, Page):
...
class ArticleListingPage(panels.ArticleListingPagePanels, Page):
...
class CampaignPage(panels.CampaignPagePanels, Page):
