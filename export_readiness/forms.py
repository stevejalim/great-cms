...
from wagtail.admin.forms import WagtailAdminPageForm as OriginalWagtailAdminPageForm
...
class WagtailAdminPageForm(OriginalWagtailAdminPageForm):
...
class WagtailAdminPageExclusivePageForm(WagtailAdminPageForm):
    def __init__(self, *args, **kwargs):
        if hasattr(self._meta.model, 'slug_identity') and 'initial' not in kwargs:
            kwargs['initial'] = {'slug': self._meta.model.slug_identity}
        super().__init__(*args, **kwargs)
